...
With full path for directory with results from RFdiffusion and full path for dl_binder_design you can run the following script - dl_design_binder (pyrosetta) env needs to be active. This script is an automation of all the steps above.
